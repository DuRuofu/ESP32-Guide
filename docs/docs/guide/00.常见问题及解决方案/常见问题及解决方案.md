...
## 7.离线安装配置插件报错：ERROR_INVALID_PIP

![](attachments/20251217230842.png)

解决办法：删除对应目录下的 idf-git 和 idf-python 两个文件夹，然后重新尝试，比如按照上图，就删除`E:\SoftwareData\Espressif\SDK\V533\tools`目录下的这两个文件夹。